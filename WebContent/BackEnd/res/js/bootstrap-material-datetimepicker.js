   ...
   Plugin.prototype =
           {
              ...
              initTemplate: function ()
              {
                 ...
                 this.template = '<div class="dtp hidden" id="' + this.name + '">' +
                         ...
                         '<button class="dtp-btn-now btn btn-success btn-sm hidden">' + this.params.nowText + '</button>' +
                         '<button class="dtp-btn-clear btn btn-success btn-sm hidden ">' + this.params.clearText + '</button>' +
                         '<button class="dtp-btn-cancel btn btn-success btn-sm">' + this.params.cancelText + '</button>' +
                         '<button class="dtp-btn-ok btn btn-success btn-sm">' + this.params.okText + '</button>' +
                         '<div class="clearfix"></div>' +
                         '</div>' +
                         '</div>' +
                         '</div>';
